...
if __name__ == "__main__":
    ...
    train_sampler = get_Sampler(sampler, train_dataset, p=16, k=16)
    ...
    # train
    train(facenet.to(device),train_loader,valid_loader,eval_loader1,eval_loader2,optimizer,scheduler,num_epochs,eval_every,margin,device,name)
